...
function App() {
  ...
  // Apply different styles based on the route
    ...
    <div
      className={`${
        isVisualizationPage
          ...
          : "min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-emerald-900 flex items-center justify-center relative overflow-hidden"
      }`}
    >
      {!isVisualizationPage && (
        <>
